            ...
            <Paper variant="outlined" sx={{ padding: 4, marginTop: 10, marginBottom: 5}}>
                <Box display="flex" justifyContent="center" alignItems="flex-start">
                    ...
                    <Stack sx={{paddingX: 2}}>
                        ...
                        <Typography sx={{textTransform:" uppercase", paddingBottom: "20px"}} variant="h6">
                            Useful links
                        </Typography>
                    ...
                    <Stack sx={{paddingX: 2}}>
                        ...
                        <Link underline="hover" sx={{ paddingBottom: 1}} href="https://thoth-station.ninja/docs/developers/adviser/landing_page.html#landing-page">
