...
export const generateImageDocument = (): ImageDocumentRequestResponseSuccess => {
  return {
    status: {
    ...
    metadata: {
      ...
      duration: 62,
      hostname: "package-extract-220106085041-a6e38c8593af545e-583709264",
      os_release: {
        id: "fedora",
        name: "Fedora",
    ...
    result: {
      ...
      mercator: [
        {
          digests: {
            manifest: "0de531970deeb450d42f8e4237e684a97590bdde",
          },
          ecosystem: "Python",
        ...
        {
          digests: {
            manifest: "75ce23d0235eca53f560195eb43160b12a95f847",
          },
          ecosystem: "Python-Dist",
        ...
        {
          digests: {
            manifest: "814775526c5c4bd46eeab3678ee3198a3d70de0f",
          },
          ecosystem: "Python-Dist",
        ...
        {
          digests: {
            manifest: "ab211004bad21f637851c6ae69a429e4a0a88c0b",
          },
          ecosystem: "Python-Dist",
        ...
        {
          digests: {
            manifest: "21f5fdafc8ecc191e8d9b720b08046056110f1d8",
          },
          ecosystem: "Python-Dist",
        ...
        {
          digests: {
            manifest: "3e91d36a66daa6666d508cc13bc388663fbf861e",
          },
          ecosystem: "Python-Dist",
        ...
        {
          digests: {
            manifest: "d1158c379e522ad8403530e7e01b55e4d1028b51",
          },
          ecosystem: "Python-Dist",
        ...
        {
          digests: {
            manifest: "3e84e9d9cd4c2495c034a29656909eb28bcd600e",
          },
          ecosystem: "Python-Dist",
        ...
        {
          digests: {
            manifest: "c195c6c568f42676ba408758d0dded193ae51cce",
          },
          ecosystem: "Python-Dist",
        ...
        {
          digests: {
            manifest: "baa46c0192b43aee0b83796850a7f75cda25723d",
          },
          ecosystem: "Python-Dist",
        ...
        {
          digests: {
            manifest: "38328935a60f227a5aab06d8612c94e8f4569e42",
          },
          ecosystem: "Python-Dist",
          ...
          result: {
            ...
            metadata_version: "2.0",
            name: "requests",
            project_url: "Source, https://github.com/psf/requests",
            ...
            run_requires: [
              ...
              {
                environment: 'sys_platform == "win32" and python_version == "2.7"',
                extra: "socks",
                requires: ["win-inet-pton"],
              },
              {
                extra: "security",
                requires: ["pyOpenSSL (>=0.14)", "cryptography (>=1.3.4)"],
              },
              {
                requires: [
                  "chardet (>=3.0.2,<4)",
        ...
        },
        {
          ...
          result: {
            ...
            run_requires: [
              {
                requires: ["click", "delegator.py (>=0.1.0)", "distro", "requests", "thoth-common"],
              },
            ],
        ...
        {
          digests: {
            manifest: "cd1d73c746a543f7a8587fd999ff4b18248b45e2",
          },
          ecosystem: "Python-Dist",
        ...
        {
          digests: {
            manifest: "7fc5aacdc0536f5eb86c63d2cb26a953773ba181",
          },
          ecosystem: "Python-Dist",
        ...
        {
          digests: {
            manifest: "8f37294c4ab88d4f52b22dc9ae4f5cdbb09a90bf",
          },
      ...
      "skopeo-inspect": {
        ...
        Labels: {
          ...
          usage:
            "s2i build https://github.com/sclorg/s2i-python-container.git --context-dir=3.8/test/setup-test-app/ ubi8/python-38 python-sample-app",
      ...
      "system-symbols": {
        "/lib64/ld-2.28.so": ["GLIBC_2.4", "GLIBC_2.2.5", "GLIBC_PRIVATE", "GLIBC_2.3"],
        "/lib64/ld-linux-x86-64.so.2": ["GLIBC_2.4", "GLIBC_2.2.5", "GLIBC_PRIVATE", "GLIBC_2.3"],
        ...
        "/lib64/libacl.so.1.1.2253": ["ACL_1.1", "ACL_1.0", "ACL_1.2"],
        ...
        "/lib64/libattr.so.1": ["ATTR_1.0", "ATTR_1.3", "ATTR_1.2", "ATTR_1.1"],
        "/lib64/libattr.so.1.1.2448": ["ATTR_1.0", "ATTR_1.3", "ATTR_1.2", "ATTR_1.1"],
        "/lib64/libblkid.so.1": [
          "BLKID_2.21",
          "BLKID_2.23",
          "BLKID_2.30",
